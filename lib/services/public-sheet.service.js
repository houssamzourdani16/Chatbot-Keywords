...
export class PublicSheetService {
  ...
  /**
   * Get ALL raw rows from the public sheet as a consistent array of arrays.
   * (Generic — usable for keywords, conversations, or any other data.)
   * Returns { rows, headers, total }
   */
  async getRows() {
